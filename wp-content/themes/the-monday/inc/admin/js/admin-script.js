...
jQuery(document).ready(function($){
    ...
    $('#accordion-panel-the_monday_general_settings').prepend(
            ...
            '<span class="sticky_info_row"><a class="button" href="http://demo.accesspressthemes.com/the-monday/" target="_blank">Demo</a>'+
            '<span class="sticky_info_row"><a class="button" href="http://doc.accesspressthemes.com/the-monday/" target="_blank">Documentation</a></span>'+
            '<span class="sticky_info_row"><a class="button" href="https://accesspressthemes.com/support/forum/themes/free-themes/theme-the-monday/" target="_blnak">Support forum</a></span>'+
